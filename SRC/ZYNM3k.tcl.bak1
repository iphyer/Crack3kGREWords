...
proc vTclWindow.top37 {base} {
    ...
    wm geometry $top 600x450+700+272
    update
    # set in toplevel.wgt.
    global vTcl
    ...
    message $top.mes38 \
        ...
        -text {请输入你希望默写的list数字(1-31)，如1,2,3,使用逗号分隔，随后点击RUN按钮。
...
有问题请联系:iphyer@163.com} \
    ...
    ###################
    place $top.mes38 \
        -in $top -x 120 -y 210 -width 385 -height 173 -anchor nw \
        -bordermode ignore 
    place $top.ent39 \
        -in $top -x 170 -y 100 -width 246 -height 21 -anchor nw \
        -bordermode ignore 
    place $top.lab40 \
